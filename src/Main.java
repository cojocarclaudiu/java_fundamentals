...
public class Main {
    public static void main(String[] args) {
        ...
        account.setType("Premium Account");
        account.setUserName("Cojocar Claudiu");
        ...
        account1.setUserName("Emilia Barba");
        account1.setType("Classic Account");
        account1.deposit(1000);
        System.out.println(account1.toString());

        account1.transfer(account, 900);
        System.out.println(account1.toString());
        System.out.println(account.toString());
